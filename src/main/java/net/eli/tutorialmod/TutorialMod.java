...
// Important message: You got this!
...
public class TutorialMod {
    ...
    private void commonSetup(final FMLCommonSetupEvent event)    {
        event.enqueueWork(() -> {
            ComposterBlock.COMPOSTABLES.put(ModItems.STRAWBERRY.get(), 0.4f);
            ComposterBlock.COMPOSTABLES.put(ModItems.STRAWBERRY_SEEDS.get(), 0.15f);
        });
    }
    ...
    public void onServerStarting(ServerStartingEvent event)
    {
        ...
        LOGGER.warn("Mod Loading/Loaded");
    }
