...
import net.eli.tutorialmod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.CERVALITE_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.JUMP, 400, 0, false, false),
                                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 400, 0, false, false)))
                    .build();
