...
public class ModTags {
    public static class Blocks {
        public static final TagKey<Block> NEEDS_CERVALITE_TOOL = createTag("needs_cervalite_tool");
        public static final TagKey<Block> INCORRECT_FOR_CERVALITE_TOOL = createTag("incorrect_for_cervalite_tool");
