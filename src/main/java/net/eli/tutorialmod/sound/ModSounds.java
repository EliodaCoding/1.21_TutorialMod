package net.eli.tutorialmod.sound;
...
public class ModSounds {
    ...
    //Need ALL 5 sounds for each custom block
    ...
    public static final RegistryObject<SoundEvent> MAGIC_BLOCK_FALL = registerSoundEvent("magic_block_fall"); //when survival player lands on block from a fall
    ...
    public static final RegistryObject<SoundEvent> UPSIDE_DOWN = registerSoundEvent("upside_down");
    public static final ResourceKey<JukeboxSong> UPSIDE_DOWN_KEY = ResourceKey.create(Registries.JUKEBOX_SONG,
            ResourceLocation.fromNamespaceAndPath(TutorialMod.MOD_ID, "upside_down"));

    //helper to register sounds
