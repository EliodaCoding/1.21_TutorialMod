package net.eli.tutorialmod.potion;
...
public class ModPotions {
    ...
    public static final RegistryObject<Potion> COMFORT_POTION = POTIONS.register("comfort_potion",
            () -> new Potion(new MobEffectInstance(ModEffects.COMFORTED_EFFECT.getHolder().get(), 200, 0)));
